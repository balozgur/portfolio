...
-- animal_shelter Colors
CREATE TABLE IF NOT EXISTS animal_shelter.Colors 
(
	Color VARCHAR(10) NOT NULL 
		PRIMARY KEY
);
INSERT INTO	animal_shelter.Colors (Color)
VALUES
('Black'), ('Brown'), ('Cream'), ('Ginger'), ('Gray'), ('White');

-- animal_shelter Species
CREATE TABLE IF NOT EXISTS animal_shelter.Species 
(
	Species VARCHAR(10) NOT NULL 
		PRIMARY KEY
);
INSERT INTO	animal_shelter.Species (Species)
VALUES
('Cat'), ('Dog'), ('Ferret'), ('Rabbit'), ('Raccoon');

-- Animals
CREATE	TABLE IF NOT EXISTS animal_shelter.Animals
(
	Name			VARCHAR(20)			NOT NULL,
	Species			VARCHAR(10)			NOT NULL
		REFERENCES animal_shelter.Species (Species),
	Primary_Color	VARCHAR(10)			NOT NULL
		REFERENCES animal_shelter.Colors (Color),
	Implant_Chip_ID	VARCHAR(38)	NOT NULL
		UNIQUE,
...
INSERT INTO	animal_shelter.Animals (Name, Species, Primary_Color, Implant_Chip_ID, Breed, Gender, Birth_Date, Pattern, Admission_Date)
VALUES
...
-- Persons
CREATE	TABLE animal_shelter.Persons
(
...
INSERT INTO	animal_shelter.Persons (Email, First_Name, Last_Name, Birth_Date, Address, State, City, Zip_Code)
VALUES
...
-- Staff
CREATE	TABLE IF NOT EXISTS animal_shelter.Staff
(
	Email		VARCHAR(100)	NOT NULL 
		PRIMARY KEY
...
INSERT INTO	animal_shelter.Staff (Email, Hire_Date)
VALUES
...
-- Staff Roles
CREATE	TABLE IF NOT EXISTS animal_shelter.Staff_Roles 
(
	Role VARCHAR(20) NOT NULL PRIMARY KEY 
);
INSERT INTO	animal_shelter.Staff_Roles (Role)
VALUES
('Assistant'),
('Janitor'),
('Manager'),
...
-- Staff Assignments
CREATE TABLE IF NOT EXISTS animal_shelter.Staff_Assignments
(
	Email		VARCHAR(100)	NOT NULL
...
INSERT INTO	animal_shelter.Staff_Assignments (Email, Role, Assigned)
VALUES
...
-- Adoptions
CREATE	TABLE IF NOT EXISTS animal_shelter.Adoptions
(
	Name			VARCHAR(20)		NOT NULL,
	Species			VARCHAR(10)		NOT NULL,
...
INSERT INTO	animal_shelter.Adoptions (Name, Species, Adopter_Email, Adoption_Date, Adoption_Fee)
VALUES
...
CREATE TABLE IF NOT EXISTS animal_shelter.Vaccinations
(
	Name				VARCHAR(20)		NOT NULL,
	Species				VARCHAR(10)		NOT NULL,
...
INSERT INTO	animal_shelter.Vaccinations (Name, Species, Vaccination_Time, Vaccine, Batch, Comments, Email)
VALUES
('Abby', 'Dog', CAST('2017-04-19T09:01:00.0000000' AS DATETIME), 'Distemper Virus', 'N-178784096', NULL, 'ashley.flores@animalshelter.com'),
('Abby', 'Dog', CAST('2018-04-19T10:44:00.0000000' AS DATETIME), 'Distemper Virus', 'L-107687717', NULL, 'wanda.myers@animalshelter.com'),
('Angel', 'Dog', CAST('2017-05-04T10:38:00.0000000' AS DATETIME), 'Distemper Virus', 'L-353180534', NULL, 'wanda.myers@animalshelter.com'),
('Angel', 'Dog', CAST('2018-05-04T09:47:00.0000000' AS DATETIME), 'Distemper Virus', 'A-271237673', NULL, 'wanda.myers@animalshelter.com'),
('Angel', 'Dog', CAST('2017-05-04T12:49:00.0000000' AS DATETIME), 'Rabies', 'V-180603107', NULL, 'wanda.myers@animalshelter.com'),
('Angel', 'Dog', CAST('2018-05-04T11:18:00.0000000' AS DATETIME), 'Rabies', 'P-118670651', NULL, 'ashley.flores@animalshelter.com'),
('Archie', 'Cat', CAST('2017-11-20T09:35:00.0000000' AS DATETIME), 'Calicivirus', 'J-460970834', NULL, 'ashley.flores@animalshelter.com'),
('Archie', 'Cat', CAST('2017-11-20T13:25:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'F-164759480', NULL, 'ashley.flores@animalshelter.com'),
('Aspen', 'Dog', CAST('2016-09-28T07:36:00.0000000' AS DATETIME), 'Adenovirus', 'M-471677500', NULL, 'wanda.myers@animalshelter.com'),
('Aspen', 'Dog', CAST('2017-09-29T12:35:00.0000000' AS DATETIME), 'Adenovirus', 'V-256362103', NULL, 'wanda.myers@animalshelter.com'),
('Aspen', 'Dog', CAST('2016-09-28T10:01:00.0000000' AS DATETIME), 'Distemper Virus', 'N-147820695', NULL, 'ashley.flores@animalshelter.com'),
('Aspen', 'Dog', CAST('2016-09-28T07:41:00.0000000' AS DATETIME), 'Rabies', 'K-430117096', NULL, 'wanda.myers@animalshelter.com'),
('Aspen', 'Dog', CAST('2017-09-29T07:32:00.0000000' AS DATETIME), 'Rabies', 'B-384980558', NULL, 'ashley.flores@animalshelter.com'),
('Baloo', 'Rabbit', CAST('2016-09-01T07:00:00.0000000' AS DATETIME), 'Rabies', 'V-411899194', NULL, 'wanda.myers@animalshelter.com'),
('Benny', 'Dog', CAST('2019-01-02T09:44:00.0000000' AS DATETIME), 'Adenovirus', 'D-237655965', NULL, 'ashley.flores@animalshelter.com'),
('Benny', 'Dog', CAST('2019-01-02T13:19:00.0000000' AS DATETIME), 'Rabies', 'H-405534627', NULL, 'robin.murphy@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2018-12-27T13:39:00.0000000' AS DATETIME), 'Myxomatosis', 'I-176340730', NULL, 'dennis.hill@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2019-12-27T13:32:00.0000000' AS DATETIME), 'Myxomatosis', 'O-237649828', NULL, 'ashley.flores@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2016-12-26T12:08:00.0000000' AS DATETIME), 'Rabies', 'N-100666243', NULL, 'wanda.myers@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2017-12-27T10:09:00.0000000' AS DATETIME), 'Rabies', 'Z-365201947', NULL, 'wanda.myers@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2018-12-27T11:09:00.0000000' AS DATETIME), 'Rabies', 'O-282699517', NULL, 'robin.murphy@animalshelter.com'),
('Bon bon', 'Rabbit', CAST('2019-12-27T09:23:00.0000000' AS DATETIME), 'Rabies', 'C-219506249', NULL, 'gerald.reyes@animalshelter.com'),
('Boomer', 'Dog', CAST('2019-09-03T11:58:00.0000000' AS DATETIME), 'Rabies', 'D-353567999', NULL, 'gerald.reyes@animalshelter.com'),
('Brutus', 'Dog', CAST('2018-11-28T12:26:00.0000000' AS DATETIME), 'Adenovirus', 'K-99075733 ', NULL, 'wanda.myers@animalshelter.com'),
('Brutus', 'Dog', CAST('2018-11-28T07:17:00.0000000' AS DATETIME), 'Distemper Virus', 'U-104436672', NULL, 'wayne.carter@animalshelter.com'),
('Cooper', 'Dog', CAST('2017-10-13T09:41:00.0000000' AS DATETIME), 'Distemper Virus', 'K-334308175', NULL, 'ashley.flores@animalshelter.com'),
('Dolly', 'Dog', CAST('2018-09-27T08:16:00.0000000' AS DATETIME), 'Adenovirus', 'F-202325284', NULL, 'ashley.flores@animalshelter.com'),
('Dolly', 'Dog', CAST('2019-09-27T10:29:00.0000000' AS DATETIME), 'Adenovirus', 'O-402995062', NULL, 'wayne.carter@animalshelter.com'),
('Dolly', 'Dog', CAST('2018-09-27T14:45:00.0000000' AS DATETIME), 'Rabies', 'T-302536393', NULL, 'robin.murphy@animalshelter.com'),
('Fiona', 'Cat', CAST('2017-12-18T11:15:00.0000000' AS DATETIME), 'Calicivirus', 'C-259489422', NULL, 'wanda.myers@animalshelter.com'),
('Fiona', 'Cat', CAST('2017-12-18T14:17:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'Y-412311976', NULL, 'wanda.myers@animalshelter.com'),
('Ginger', 'Dog', CAST('2017-03-07T08:33:00.0000000' AS DATETIME), 'Adenovirus', 'B-141623834', NULL, 'wanda.myers@animalshelter.com'),
('Gizmo', 'Dog', CAST('2019-08-22T08:52:00.0000000' AS DATETIME), 'Distemper Virus', 'H-384444123', NULL, 'wayne.carter@animalshelter.com'),
('Hobbes', 'Cat', CAST('2016-12-26T12:54:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'X-224232315', NULL, 'ashley.flores@animalshelter.com'),
('Holly', 'Dog', CAST('2019-07-15T13:14:00.0000000' AS DATETIME), 'Rabies', 'D-117727724', NULL, 'robin.murphy@animalshelter.com'),
('Humphrey', 'Rabbit', CAST('2018-08-28T08:09:00.0000000' AS DATETIME), 'Myxomatosis', 'H-250858054', NULL, 'gerald.reyes@animalshelter.com'),
('Humphrey', 'Rabbit', CAST('2018-08-28T09:41:00.0000000' AS DATETIME), 'Rabies', 'U-255625602', NULL, 'robin.murphy@animalshelter.com'),
('Humphrey', 'Rabbit', CAST('2018-08-28T10:08:00.0000000' AS DATETIME), 'Viral Haemorrhagic Disease', 'I-404631209', NULL, 'gerald.reyes@animalshelter.com'),
('Jake', 'Dog', CAST('2017-12-08T07:46:00.0000000' AS DATETIME), 'Adenovirus', 'T-332043529', NULL, 'wanda.myers@animalshelter.com'),
('Lucy', 'Dog', CAST('2018-05-22T07:46:00.0000000' AS DATETIME), 'Distemper Virus', 'L-258258441', NULL, 'ashley.flores@animalshelter.com'),
('Luna', 'Dog', CAST('2019-09-03T13:30:00.0000000' AS DATETIME), 'Adenovirus', 'O-245391721', NULL, 'wayne.carter@animalshelter.com'),
('Misty', 'Cat', CAST('2019-08-09T09:13:00.0000000' AS DATETIME), 'Calicivirus', 'I-259629161', NULL, 'dennis.hill@animalshelter.com'),
('Misty', 'Cat', CAST('2019-08-09T09:00:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'Y-383139393', NULL, 'gerald.reyes@animalshelter.com'),
('Nala', 'Dog', CAST('2019-07-26T13:15:00.0000000' AS DATETIME), 'Adenovirus', 'S-115426515', NULL, 'ashley.flores@animalshelter.com'),
('Nova', 'Cat', CAST('2018-08-13T14:32:00.0000000' AS DATETIME), 'Leukemia Virus', 'E-489987614', NULL, 'ashley.flores@animalshelter.com'),
('Nova', 'Cat', CAST('2018-08-13T11:35:00.0000000' AS DATETIME), 'Rabies', 'C-386537135', NULL, 'ashley.flores@animalshelter.com'),
('Odin', 'Dog', CAST('2019-10-25T14:02:00.0000000' AS DATETIME), 'Adenovirus', 'Z-490194302', NULL, 'robin.murphy@animalshelter.com'),
('Odin', 'Dog', CAST('2017-10-25T07:58:00.0000000' AS DATETIME), 'Rabies', 'N-322162073', NULL, 'ashley.flores@animalshelter.com'),
('Odin', 'Dog', CAST('2019-10-25T09:11:00.0000000' AS DATETIME), 'Rabies', 'L-181928453', NULL, 'wayne.carter@animalshelter.com'),
('Oscar', 'Cat', CAST('2018-03-22T07:15:00.0000000' AS DATETIME), 'Herpesvirus', 'L-196623340', NULL, 'wanda.myers@animalshelter.com'),
('Oscar', 'Cat', CAST('2018-03-22T07:12:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'S-427830689', NULL, 'ashley.flores@animalshelter.com'),
('Oscar', 'Cat', CAST('2018-03-22T13:19:00.0000000' AS DATETIME), 'Rabies', 'K-153175906', NULL, 'ashley.flores@animalshelter.com'),
('Patches', 'Cat', CAST('2019-10-21T09:56:00.0000000' AS DATETIME), 'Leukemia Virus', 'H-151581256', NULL, 'wanda.myers@animalshelter.com'),
('Penelope', 'Cat', CAST('2017-12-22T08:29:00.0000000' AS DATETIME), 'Calicivirus', 'H-233459270', NULL, 'wanda.myers@animalshelter.com'),
('Penelope', 'Cat', CAST('2017-12-22T09:42:00.0000000' AS DATETIME), 'Rabies', 'T-245247914', NULL, 'wanda.myers@animalshelter.com'),
('Penelope', 'Dog', CAST('2017-01-12T12:42:00.0000000' AS DATETIME), 'Distemper Virus', 'M-466473114', NULL, 'ashley.flores@animalshelter.com'),
('Penelope', 'Dog', CAST('2017-01-12T14:39:00.0000000' AS DATETIME), 'Rabies', 'R-249697441', NULL, 'ashley.flores@animalshelter.com'),
('Penelope', 'Dog', CAST('2018-01-12T08:20:00.0000000' AS DATETIME), 'Rabies', 'G-252982705', NULL, 'ashley.flores@animalshelter.com'),
('Poppy', 'Dog', CAST('2018-12-17T09:34:00.0000000' AS DATETIME), 'Rabies', 'W-142526378', NULL, 'robin.murphy@animalshelter.com'),
('Pumpkin', 'Cat', CAST('2019-08-07T11:03:00.0000000' AS DATETIME), 'Herpesvirus', 'R-266824458', NULL, 'gerald.reyes@animalshelter.com'),
('Pumpkin', 'Cat', CAST('2019-08-07T09:09:00.0000000' AS DATETIME), 'Rabies', 'C-414219200', NULL, 'robin.murphy@animalshelter.com'),
('Ranger', 'Dog', CAST('2018-11-28T11:39:00.0000000' AS DATETIME), 'Adenovirus', 'P-300099414', NULL, 'ashley.flores@animalshelter.com'),
('Ranger', 'Dog', CAST('2017-11-28T11:59:00.0000000' AS DATETIME), 'Distemper Virus', 'W-358599750', NULL, 'ashley.flores@animalshelter.com'),
('Ranger', 'Dog', CAST('2018-11-28T07:27:00.0000000' AS DATETIME), 'Distemper Virus', 'K-483728872', NULL, 'wanda.myers@animalshelter.com'),
('Remi / Remy', 'Dog', CAST('2018-11-14T11:49:00.0000000' AS DATETIME), 'Distemper Virus', 'S-337547458', NULL, 'gerald.reyes@animalshelter.com'),
('Roxy', 'Dog', CAST('2019-01-04T07:55:00.0000000' AS DATETIME), 'Adenovirus', 'Q-206330713', NULL, 'ashley.flores@animalshelter.com'),
('Roxy', 'Dog', CAST('2019-01-04T12:58:00.0000000' AS DATETIME), 'Distemper Virus', 'P-281685593', NULL, 'dennis.hill@animalshelter.com'),
('Sadie', 'Cat', CAST('2016-10-06T07:02:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'C-229285711', NULL, 'ashley.flores@animalshelter.com'),
('Sam', 'Cat', CAST('2018-11-09T13:46:00.0000000' AS DATETIME), 'Herpesvirus', 'W-462716953', NULL, 'wanda.myers@animalshelter.com'),
('Sammy', 'Dog', CAST('2018-07-06T12:29:00.0000000' AS DATETIME), 'Adenovirus', 'Q-336566517', NULL, 'wanda.myers@animalshelter.com'),
('Sammy', 'Dog', CAST('2018-07-06T10:58:00.0000000' AS DATETIME), 'Distemper Virus', 'H-245193858', NULL, 'ashley.flores@animalshelter.com'),
('Samson', 'Dog', CAST('2019-11-15T10:11:00.0000000' AS DATETIME), 'Distemper Virus', 'R-497123324', NULL, 'gerald.reyes@animalshelter.com'),
('Shadow', 'Dog', CAST('2016-12-29T08:43:00.0000000' AS DATETIME), 'Distemper Virus', 'T-135880561', NULL, 'wanda.myers@animalshelter.com'),
('Shelby', 'Dog', CAST('2016-04-18T14:04:00.0000000' AS DATETIME), 'Adenovirus', 'L-438221809', NULL, 'ashley.flores@animalshelter.com'),
('Shelby', 'Dog', CAST('2017-04-19T13:33:00.0000000' AS DATETIME), 'Adenovirus', 'U-447076076', NULL, 'wanda.myers@animalshelter.com'),
('Simon', 'Cat', CAST('2018-05-30T14:15:00.0000000' AS DATETIME), 'Calicivirus', 'Q-478638360', NULL, 'gerald.reyes@animalshelter.com'),
('Skye', 'Dog', CAST('2016-08-10T10:51:00.0000000' AS DATETIME), 'Distemper Virus', 'E-236843325', NULL, 'ashley.flores@animalshelter.com'),
('Skye', 'Dog', CAST('2016-08-10T09:53:00.0000000' AS DATETIME), 'Rabies', 'A-171447806', NULL, 'wanda.myers@animalshelter.com'),
('Stella', 'Dog', CAST('2018-01-03T08:20:00.0000000' AS DATETIME), 'Adenovirus', 'K-380962117', NULL, 'ashley.flores@animalshelter.com'),
('Thomas', 'Cat', CAST('2019-05-09T07:25:00.0000000' AS DATETIME), 'Leukemia Virus', 'N-431089273', NULL, 'wayne.carter@animalshelter.com'),
('Thomas', 'Cat', CAST('2019-05-09T12:27:00.0000000' AS DATETIME), 'Rabies', 'Z-112256475', NULL, 'wanda.myers@animalshelter.com'),
('Thor', 'Dog', CAST('2017-03-22T11:45:00.0000000' AS DATETIME), 'Adenovirus', 'U-127749818', NULL, 'ashley.flores@animalshelter.com'),
('Thor', 'Dog', CAST('2019-03-22T14:24:00.0000000' AS DATETIME), 'Adenovirus', 'M-229481627', NULL, 'wanda.myers@animalshelter.com'),
('Thor', 'Dog', CAST('2017-03-22T09:58:00.0000000' AS DATETIME), 'Distemper Virus', 'I-370298118', NULL, 'ashley.flores@animalshelter.com'),
('Thor', 'Dog', CAST('2019-03-22T07:15:00.0000000' AS DATETIME), 'Distemper Virus', 'A-455989697', NULL, 'dennis.hill@animalshelter.com'),
('Tigger', 'Cat', CAST('2018-01-04T13:28:00.0000000' AS DATETIME), 'Leukemia Virus', 'F-321237388', NULL, 'ashley.flores@animalshelter.com'),
('Tigger', 'Cat', CAST('2019-01-04T11:15:00.0000000' AS DATETIME), 'Leukemia Virus', 'P-236394443', NULL, 'gerald.reyes@animalshelter.com'),
('Tigger', 'Cat', CAST('2017-01-04T14:52:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'R-191602716', NULL, 'wanda.myers@animalshelter.com'),
('Tigger', 'Cat', CAST('2019-01-04T08:49:00.0000000' AS DATETIME), 'Panleukopenia Virus', 'T-370701265', NULL, 'dennis.hill@animalshelter.com'),
('Tigger', 'Cat', CAST('2018-01-04T10:27:00.0000000' AS DATETIME), 'Rabies', 'L-382821941', NULL, 'ashley.flores@animalshelter.com'),
('Tigger', 'Cat', CAST('2019-01-04T09:08:00.0000000' AS DATETIME), 'Rabies', 'V-177428557', NULL, 'robin.murphy@animalshelter.com'),
('Walter', 'Dog', CAST('2018-08-27T11:10:00.0000000' AS DATETIME), 'Distemper Virus', 'B-226925017', NULL, 'ashley.flores@animalshelter.com'),
('Walter', 'Dog', CAST('2019-08-27T12:32:00.0000000' AS DATETIME), 'Distemper Virus', 'X-480746334', NULL, 'wayne.carter@animalshelter.com'),
('Walter', 'Dog', CAST('2018-08-27T14:21:00.0000000' AS DATETIME), 'Rabies', 'O-242396268', NULL, 'robin.murphy@animalshelter.com'),
('Walter', 'Dog', CAST('2019-08-27T09:03:00.0000000' AS DATETIME), 'Rabies', 'L-366676246', NULL, 'robin.murphy@animalshelter.com');